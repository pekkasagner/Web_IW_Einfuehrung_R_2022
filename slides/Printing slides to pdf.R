...
# xaringan_to_pdf(input = "04_Vorlesung_messy_data_tidy_data.html")

# xaringan_to_pdf(input = "05_Vorlesung_daten_zusammenfuehren.html")

# xaringan_to_pdf(input = "06_Vorlesung_Deskriptive_Statistiken.html")

xaringan_to_pdf(input = "07_Vorlesung_Funktionen_Iteration.html")