...
[`r fontawesome::fa("code")` Musterlösung für &raquo;Übungsblatt 1 - Erste Schritte mit R und R-Studio&laquo; als R-Datei öffnen]()
...
[`r fontawesome::fa("file-pdf")` Folien &raquo;Einführung in das Tidyverse&laquo; als PDF-Datei öffnen]() 
...
[`r fontawesome::fa("file-pdf")` Übungsblatt &raquo;Übungsblatt 2 - Einführung in das Tidyverse&laquo; als PDF-Datei öffnen]() 
...
[`r fontawesome::fa("code")` Musterlösung für &raquo;Übungsblatt 2 - Einführung in das Tidyverse&laquo; als R-Datei öffnen]()
...
[`r fontawesome::fa("file-archive")` Datensatz &raquo;olympics&laquo; als CSV-Datei öffnen]()
...
[`r fontawesome::fa("file-pdf")` Folien &raquo;Grammar of graphics (ggplot)&laquo; als PDF-Datei öffnen]() 
...
[`r fontawesome::fa("file-pdf")` Übungsblatt &raquo;Übungsblatt 3 - Einführung in ggplot2&laquo; als PDF-Datei öffnen]() 
...
[`r fontawesome::fa("code")` Musterlösung für &raquo;Übungsblatt 3 - Einführung in ggplot2&laquo; als R-Datei öffnen]()
...
[`r fontawesome::fa("file-archive")` Datensatz &raquo;datasaurus&laquo; als TSV-Datei öffnen]()
...
[`r fontawesome::fa("file-pdf")` Übungsblatt &raquo;Übungsblatt 4 - Messy Data &zigrarr; Tidy Data&laquo; als PDF-Datei öffnen]() 
...
[`r fontawesome::fa("code")` Musterlösung für &raquo;Übungsblatt 4 - Messy Data &zigrarr; Tidy Data&laquo; als R-Datei öffnen]()
...
[`r fontawesome::fa("file-archive")` Datensatz &raquo;Einkommen_Kreise&laquo; als xlsx-Datei öffnen]()
...
[`r fontawesome::fa("file-pdf")` Folien &raquo;Daten zusammenführen&laquo; als PDF-Datei öffnen]() 
...
[`r fontawesome::fa("file-pdf")` Übungsblatt &raquo;Übungsblatt 5 - Mutating Joins - Grundlagen&laquo; als PDF-Datei öffnen]() 
...
[`r fontawesome::fa("code")` Musterlösung für &raquo;Übungsblatt 5 -Mutating Joins - Grundlagen&laquo; als R-Datei öffnen]()
...
[`r fontawesome::fa("file-archive")` Datensatz &raquo;studis_fh_2017&laquo; als CSV-Datei öffnen]()

[`r fontawesome::fa("file-archive")` Datensatz &raquo;studis_fh&laquo; als CSV-Datei öffnen]()

[`r fontawesome::fa("file-archive")` Datensatz &raquo;studis_insg_2017&laquo; als CSV-Datei öffnen]()

[`r fontawesome::fa("file-archive")` Datensatz &raquo;studis_insg&laquo; als CSV-Datei öffnen]()
...
[`r fontawesome::fa("file-pdf")` Folien &raquo;Geodaten&laquo; als PDF-Datei öffnen]() 
...
[`r fontawesome::fa("file-pdf")` Übungsblatt &raquo;Übungsblatt 6 - Geodaten visualisieren&laquo; als PDF-Datei öffnen]() 
...
[`r fontawesome::fa("code")` Musterlösung für &raquo;Übungsblatt 6 - Geodaten visualisieren&laquo; als R-Datei öffnen]()
...
[`r fontawesome::fa("file-archive")` Datensatz &raquo;Geometrie_Corona_Landkreise&laquo; als GEOJSON-Datei öffnen]()

[`r fontawesome::fa("file-archive")` Datensatz &raquo;Bundesland_clean&laquo; als ZIP-Ordner öffnen]()

[`r fontawesome::fa("file-archive")` Datensatz &raquo;Arbeitslosenquote_Bundeslaender_clean&laquo; als CSV-Datei öffnen]()

[`r fontawesome::fa("file-archive")` Datensatz &raquo;Fallzahlen_Inzidenz_aktualisiert&laquo; als XLSX-Datei öffnen]()
